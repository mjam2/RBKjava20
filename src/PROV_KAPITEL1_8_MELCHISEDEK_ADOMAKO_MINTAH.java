...
public class PROV_KAPITEL1_8_MELCHISEDEK_ADOMAKO_MINTAH {
    public static void main(String[] args) {
        ...
        System.out.println("Dina kompisars namn består av totalt "+kompisar.toString().length()+" bokstäver."); //skriver ut antal bokstäver i kompisarnas namn
